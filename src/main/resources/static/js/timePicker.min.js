...
(function (factory) {
	...
	var methods = {
		...
		remove: function()
		{
			...
			var settings = self.data('timepicker-settings');
			self.removeAttr('autocomplete', 'on');
			self.removeAttr('value', '08:00am');
	...
	function _render(self)
	{
		...
		if (settings.useSelect) {
			list = $('<select />', { 'class': 'ui-timepicker-select col-md-12 col-sm-12 form-control' , 'name' : 'time', 'type': 'select','id': 'time'});
			var wrapped_list = list;
		} else {
			list = $('<ul />', { 'class': 'ui-timepicker-list col-md-12' });
		...
		for (var i=0; i<settings.timeFormat.length; i++) {
			...
			switch (code) {
				...
				case 's':
					...
					output += (seconds > 9) ? seconds : ''+seconds;
					break;
